...
srun python3 simple_multi-predictions.py --model "../models/finbert-large-deepl" --data "../annotations/all_annotations.tsv" --tokenizer "TurkuNLP/bert-base-finnish-cased-v1" --filename "../predictions/annotated-large.tsv" #--lines $LINES
